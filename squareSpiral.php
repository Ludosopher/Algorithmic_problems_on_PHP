...
/*
Задача. Требуется написать метод, принимающий на вход размеры двумерного массива и выводящий массив в виде инкременированной
...
squareSpiral(10, 10); // Реализация итогового метода
...
function coordinates ($groups) // Определение координат шагов, последовательно формирующих спираль.
{
    ...
    for ($i = 0; $i < count($groups); $i++) { // Создание массива координат строк и столбцов шагов спирали через итерацию массива групп шагов
        ...
        // Определение последних двух трендов перед тегущей группой шагов; отдельно для строк и столбцов.
        $pastColTrend = $alterTrends[$colTrendNum];
        $pastRowTrend = $alterTrends[$rowTrendNum];
        // Формирование массивов координат текущей группы шагов; отдельно для строк и столбцов.
        ...
        // Фиксация последнего значения координат шагов после каждой итерации; отдельно для строк и столбцов.
